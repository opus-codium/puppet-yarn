  ...
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      context 'with install_method => source' do
        ...
        it {
          is_expected.to contain_file('/opt/yarn')
            .with_ensure('directory')
            .with_owner('root')
        }

        it {
          is_expected.to contain_exec('wget https://yarnpkg.com/latest.tar.gz')
        ...
        it {
          is_expected.to contain_exec('tar zvxf yarn.tar.gz')
        ...
        it {
          is_expected.to contain_file('/usr/local/bin/yarn')
            .with_ensure('link')
            .with_owner('root')
      ...
      context 'with install_method => package' do
        ...
        it {
          is_expected.to contain_package('yarn')
            .with_ensure('present')
        }
      ...
      context 'with install_method => npm' do
        ...
        it {
          is_expected.to contain_exec('npm install -g yarn')
      ...
      context 'with install_method => npm & package_ensure => absent' do
        ...
        it {
          is_expected.to contain_exec('npm uninstall -g yarn')
